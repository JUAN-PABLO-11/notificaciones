...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Ahora inicializar NotificationService con el userRepository del autenticador
        notificationService = new NotificationService(authenticator.getUserRepository(), eventManager);
        notificationService.setInvoker(invoker);
        
        // Registrar AutoNotifier para eventos tipados después de tener el notificationService completo
    ...
    private void initializeSystem() {
        ...
        // El NotificationService se inicializará después en el método start()
        // cuando tengamos acceso al userRepository
    }
